...
st.sidebar.markdown("---")
st.sidebar.header("🛠️ 全局物理常数")
mu = st.sidebar.number_input("血液/实验液体粘度 (Pa·s)", value=0.0040, format="%.4f")
rho_blood = st.sidebar.number_input("液体密度 (kg/m³)", value=1040)
P_atm = st.sidebar.number_input("大气压 (Pa)", value=101325)

st.sidebar.header("📏 实验装置预设 (mm)")
...
st.download_button("📥 下载全分支实验数据 (CSV)", csv, "windkessel_all_vessels.csv", "text/csv")